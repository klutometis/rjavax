           ...
           error=function(e) {
             ...
             contains <-
               if (is.null(superclass))
                 ...
                 superclassName
### FIXME: this must also include the interfaces, sorted lexicographically,
### iff the class explicitly implements the interface (not through inheritance)
               }
             ...
             setRefClass(className, contains=contains, methods=methods)
           })
